...
$(document).ready(function () {
  ...
  var latlng = new google.maps.LatLng(-6.1440217, 106.6821113);
  ...
  var infowindow = new google.maps.InfoWindow({
    content: '<div class="info"><strong>My Company</strong><br><br>My company address is Jurumudi<br> Indonesia</div>'
  });
});